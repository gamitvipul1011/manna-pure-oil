...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-yellow-100 via-yellow-200 to-purple-50">

      <div className="max-w-4xl mx-auto px-4 text-center">

        {/* TITLE */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-brand-purple-800 mb-14">
          {currentLang === "gu" ? "ગ્રાહકોના અનુભવ" : "Customer Experiences"}

          <span className="block text-lg text-gray-500 mt-3">
            {currentLang === "gu"
        ...
        >
          ...
          {testimonials.map((item, index) => (
            ...
            <SwiperSlide key={index}>
              ...
              <div className="bg-white px-10 py-12 rounded-3xl shadow-xl max-w-3xl mx-auto">
                ...
                {/* NAME */}
                <h4 className="font-bold text-brand-purple-800 mt-6 text-lg">
