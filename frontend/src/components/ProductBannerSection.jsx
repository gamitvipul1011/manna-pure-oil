...
const products = [
  {
    ...
    descGu:
      "પરંપરાગત કોલ્ડ પ્રેસ પદ્ધતિથી બનાવેલું શુદ્ધ શીંગતેલ. હૃદય માટે લાભદાયક.",
    descEn:
      "Pure cold-pressed groundnut oil made using traditional wooden press. Heart friendly.",
  ...
  },
  {
    ...
    nameEn: "Mustard Oil",
    descGu:
      "પાચન માટે ઉત્તમ અને ભારતીય રસોઈ માટે આદર્શ રાઈ તેલ.",
    descEn:
      "Ideal mustard oil for digestion and authentic Indian cooking.",
  ...
  },
  {
    ...
    descGu:
      "એન્ટીઑક્સિડન્ટ્સથી ભરપૂર, હાડકાં અને ત્વચા માટે લાભદાયક.",
    descEn:
      "Rich in antioxidants, beneficial for bones and skin.",
  ...
  },
  {
    ...
    nameEn: "Coconut Oil",
    descGu:
      "શુદ્ધ સુગંધ અને આરોગ્ય માટે ઉત્તમ નાળિયેર તેલ.",
    descEn:
      "Pure aromatic coconut oil for health, hair and skin.",
  ...
  descGu:
    "પોષક તત્વોથી ભરપૂર, વાળ અને ત્વચા માટે ખૂબ લાભદાયક.",
  descEn:
    "Rich in nutrients, highly beneficial for hair and skin.",
...
},
{
  ...
  nameEn: "Castor Oil",
  descGu:
    "વાળની વૃદ્ધિ અને ત્વચા સંભાળ માટે ઉપયોગી કુદરતી તેલ.",
  descEn:
    "Natural oil useful for hair growth and skin care.",
...
},
{
  ...
  descGu:
    "હળવું અને હૃદય માટે લાભદાયક તેલ, દૈનિક રસોઈ માટે યોગ્ય.",
  descEn:
    "Light and heart-healthy oil, perfect for daily cooking.",
...
},
  {
    ...
    nameEn: "Gir Cow Ghee",
    descGu:
      "પરંપરાગત બિલોના પદ્ધતિથી બનાવેલું શુદ્ધ દેશી ઘી.",
    descEn:
      "Pure gir cow ghee made using traditional bilona method.",
...
const ProductBannerSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-brand-purple-600 via-purple-500 to-[#b308d1]">
  ...
  bg-gradient-to-br from-yellow-100 via-yellow-200 to-orange-100
  rounded-3xl shadow-xl p-10">
              ...
              {/* CONTENT */}
              <div>
                <h3 className="text-3xl font-bold text-brand-purple-800 mb-4">
