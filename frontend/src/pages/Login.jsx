    ...
    try {
      if (isLogin) {
        ...
        if (!formData.name || !formData.email || !formData.password) {
          setError("Please fill all required fields / બધા field ભरো");
          setLoading(false);
          return;
        }
      ...
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-brand-purple-400 text-sm mb-1">
            {isLogin ? 'ફרੀ ખrIdi maaete' : 'aaakount banavo'}
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {!isLogin && (
            <div className="relative">
              ...
              <input type="tel" name="phone" placeholder={`${t('phone')} / ফون (Optional)`}
          ...
          <div className="relative">
            ...
            <input type="password" name="password" placeholder={`${t('password')} / પாਸvard`}
