      ...
      <Link to={`/product/${product._id}`}>
        ...
        <div className="w-full h-[220px] sm:h-[260px] md:h-[320px] overflow-hidden bg-gradient-to-br from-amber-50 to-amber-100 relative">
          <OptimizedImage
            ...
            width="100%"
            height="100%"
            className={`${inStock ? '' : 'grayscale opacity-60'}`}
          ...
          {/* Quick View */}
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition bg-black/10 z-10">
