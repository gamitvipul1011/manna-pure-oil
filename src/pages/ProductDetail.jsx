...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    setProduct(p);
    setImgLoaded(false);
    setSelectedSizeIdx(0);   // ✅ Reset
    setSelectedImageIdx(0);  // ✅ Reset
    setQuantity(1);          // ✅ Reset
    setActiveTab("description"); // ✅ Reset
    ...
    window.scrollTo(0, 0);
  }, [id, navigate]); // ✅ navigate dependency add
    ...
    <div className="min-h-screen bg-gradient-purple overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8">
        <button
          ...
          transition font-semibold group mb-6"
        >
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                rounded-xl bg-purple-600 text-white font-semibold"
              >
                <FaShoppingCart />
                {addedAnim
                  ? isGu ? "ઉમેરાયું!" : "Added!"
              ...
              {/* ✅ Buy Now - only navigate if added successfully */}
              <button
                onClick={() => {
            ...
            <a
              ...
              rounded-xl text-white bg-green-500 font-semibold"
            >
              <FaWhatsapp />
